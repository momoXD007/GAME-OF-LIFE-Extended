...
Für die Visualisierung der Daten des SIR-Modells wurde im Nachfolgenden die SIR-Simulation von Hans Nesse benutzt.\cite{•}
...
Eine weitere Schwachstelle der Implementation ist die Verwendung eines Generators von Zufallszahlen. Dieser kann nur pseudo-Zufallszahlen erzeugen welche von einem sogenannten Seed und der Aufrufe des Generators abhängen\cite{https://docs.oracle.com/javase/6/docs/api/java/util/Random.html}. Sollte es vorkommen dass zwei Simulationen einen Zufallsgenerator mit gleichem Seed nutzen und auch ansonsten die gleichen Aufrufe des Zufallsgenerators ausführen, so werden die exakt gleichen Zufallszahlen erzeugt und die Simulation wird zum exakt gleichem Ergebnis führen.
